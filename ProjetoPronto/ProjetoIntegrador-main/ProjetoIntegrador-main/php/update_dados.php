<?php
	...
	if ($query_select->num_rows >0) { 
		...
		$insert_da="INSERT INTO `tb_dadoscliente` (`cod_dadosC`,`login_dadosC`,`nome_dadosC`,`telefone_dadosC`,`rg_dadosC`,`dt_nasc_dadosC`)
										   VALUES ( $id_user,'$email_user','$nome_dados',$telefone_dados, '$rg_dados' ,'$data_nasc_dados')";
