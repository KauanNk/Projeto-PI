            ...
            <form id="form_dados" method="post" action="">
              ...
              <div> <!-- inline/dois inputs na mesma linha -->
                <div style="width: 50%; float: left;">
                  <label>NOME DO CACHORRO</label><br>
                ...
                <label>Data e Local</label><br>
                  <p style="margin: 0;"> 
                    <select id="local_consulta" name="local_consulta">
                      <option>TEUKUNAVARA</option>
                      <option>GOLEIRO BRUNO</option>
                    </select>
              ...
              <form id="form_agendamento" method="post" action="" style="clear: both;">
                ...
                <hr style="margin: 0;">
                <button type="submit" id="agendar" onclick="recarregar()" class="bk-azul-escuro color-white"> Agendar Consultoria </button>
                <br style="clear: both;"> 
        ...
        <div id="div-todos" class="box-s bk-azul-escuro ">
          ...
          if ($sel_agenda->num_rows>0) {
            while($row_agenda=mysqli_fetch_array($sel_agenda)){ 
              ...
              <div class="card">
                 <p style="font-size: 16px;" class="frase destaque">Pet Shop: <?php echo $row_agenda['local_agenda'].' - <span id="cor">'. $status .'</span>'; ?></p>
              
                 <p class="frase font15"><span class="destaque">Nome do Cachorro:</span> <?php echo $row_agenda['rg_dadosC']; ?> </p>
                 <p class="frase font15"><span class="destaque">Nome do cliente :</span> <?php echo $row_agenda['nome_dadosC']; ?> </p>
                 <p class="frase font15"><span class="destaque">Telefone:</span> <?php echo $row_agenda['telefone_dadosC']; ?> </p>
                 <p class="frase font15"><span class="destaque">Horario:</span> <?php echo $row_agenda['horario_agenda']; ?> </p>
                 <p class="frase font15"><span class="destaque">Data:</span> <?php echo $row_agenda['data_agenda']; ?> </p>
                  ...
                  ?>
                    <form method="post" action="" id="form_cancel" onsubmit='return confirm("Realmente deseja cancelar o agendamento?")'>
                      ...
                      <input type="submit" name="del_mensagem" class="cancel_cons" value="Cancelar Agendamento">
                    </form> 
                  <?php
                    } //if($status=="Agendado")
                  ?>
